...
<!--
FICHIER = contenu SKILL.md corrigé, prêt à réinstaller via Cowork > Paramètres > Capabilities.
Corrige le skill installé (cache lecture seule) : auth .env (pas Key Vault), DDL réel, UPSERT.
2026-06-29 — aligné poste Marlène.
-->
